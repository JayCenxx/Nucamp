...
console.log('motorcycles[0]:', moto1.model);
console.log('motorcycles[1]:', moto2.model);
console.log('motorcycles[2]:', moto3.model);
...
const {make,model:two,cc}=moto3

console.log(`Challenge 3: ${make} ${two}, ${cc}cc`);
